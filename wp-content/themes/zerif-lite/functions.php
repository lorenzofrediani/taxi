			...
			if( !empty($instance['image_uri']) && ($instance['image_uri'] != 'Upload Image') ) {
				if( !empty($instance['link']) ) { ?>
                    <a href="<?php echo esc_url($instance['link']); ?>" class="service-icon">
	                    ...
	                    <i class="pixeden" style="background:url(<?php echo esc_url(photonify($instance['image_uri'])); ?>) no-repeat center;width:100%; height:100%;"></i>
                    </a>
                    <?php
				} else { ?>
                    <div class="service-icon" tabindex="0">
                        <i class="pixeden" style="background:url(<?php echo esc_url(photonify($instance['image_uri'])); ?>) no-repeat center;width:100%; height:100%;"></i> <!-- FOCUS ICON-->
                    </div>
                    <?php
				} ?>
					...
					if( !empty($zerif_ourfocus_custom_media_id) && !empty($zerif_ourfocus_custom_media_id[0]) ) {
						...
						if( !empty($instance['link']) ) { ?>
                            <a href="<?php echo esc_url($instance['link']); ?>" class="service-icon">
	                            ...
	                            <i class="pixeden" style="background:url(<?php echo esc_url(photonify($zerif_ourfocus_custom_media_id[0])); ?>) no-repeat center;width:100%; height:100%;"></i>
                            </a>
                            <?php
						} else { ?>
                            <div class="service-icon" tabindex="0">
                                <i class="pixeden" style="background:url(<?php echo esc_url(photonify($zerif_ourfocus_custom_media_id[0])); ?>) no-repeat center;width:100%; height:100%;"></i> <!-- FOCUS ICON-->
                            </div>
                            <?php
						}
					}
